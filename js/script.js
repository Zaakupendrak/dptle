	...
	winDow.load( function(){
		var mainDiv = $('#container'),
			...
			preloader.fadeOut(400, function(){
				...
				/* Tło poniżej obrazków */
				/*body.delay(400).css('background', '#eaeaea');*/
				body.delay(400).css('background', '#ffffff');
			});
	});
...
/* Ustawienie szerokosc obrazków kiedy są 3 obok siebie w widoku projektu*/
var slides = $('.flexslider .slides');
var slidesW = slides.width();
// console.log("slidesW: " + slidesW);
var imgW = Math.floor((slidesW-60)/3);

// $('.flexslider .slides li img').each(function() {
// 	console.log("slidesH: " + slidesH);
// 	console.log("this: " + $(this).attr("src"));
// 	$(this).css('height', slidesH);
// });

$('.flexslider .slides .row_table').each(function (rowIdx) {
	// $(this).css('height', slidesH);
	// console.log("divW: " + $(this).width());
	var $divs = $(this).children();
	$divs.each(function(divIdx){
		if (divIdx == 0){
			$(this).children('img').css('width', imgW);
			$(this).children('img').css('margin-left', '0');
			$(this).children('img').css('margin-right', 'auto');
		}
		else if (divIdx == 1)
		{
			$(this).children('img').css('width', imgW);
			$(this).children('img').css('margin-left', 'auto');
			$(this).children('img').css('margin-right', 'auto');
		}
		else {
			$(this).children('img').css('width', imgW);
...
if (window.innerWidth >= 1025) {
	let foot = $('.header-foot'),
		innerH = window.innerHeight,
		socialIcons = document.getElementsByClassName('social-icons').item(0),
		socialIconsRect = socialIcons.getBoundingClientRect(),
		diff = innerH - Math.ceil(socialIconsRect.height) - 5;
	foot.css('top', diff + 'px');
}
...
// 		conttactBoxPaddingTop = contactBox.position()['top'];
// 	contactBox.css('padding-top', 50);
// 	map.css('min-height', '1000px');
// 	map.css('padding-top', conttactBoxPaddingTop + contactBox.outerHeight());
// }
